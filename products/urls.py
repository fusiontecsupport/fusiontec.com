...
urlpatterns = [
    ...
    path('tally-prime-server/', views.tally_prime_server_page, name='tally_prime_server'),
    ...
    path('product-form/<str:type_name>/', views.product_type_form, name='product_type_form'),
    ...
    path('digital-signature/price-list/', views.dsc_price_list_page, name='dsc_price_list_page'),
    path('digital-signature/submit/', views.dsc_integrated_submission, name='dsc_integrated_submission'),
